...
public class PushNotification extends Plugin {
	...
	static final String TAG = "com.xvitae";
	...
	public PluginResult execute(String action, JSONArray args, String callbackId) {
		...
		try{
			if (action.equals("registerWithPushProvider")) {
				...
				obj.put("deviceid", device.getUuid().toString() );
			    ...
			    payloads.put("google", options.getString("message"));
	...
	public static void sendPush(JSONObject pushMessage) {
		...
		Log.i("Push.plugin",pushMessage.toString());
